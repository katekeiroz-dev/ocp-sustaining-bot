    ...
    def decorator(func: Callable):
        def wrapper(*args, **kwargs):
            try:
                ...
                logger.warning(f"Job {func.__name__} skipped - another instance is running: {e}")
                return None
            except Exception as e:
...
class JobScheduler:
    ...
    def add_interval_job(
        ...
        **kwargs
        ...
        interval_str = f"{seconds}s" if seconds else f"{minutes}m" if minutes else f"{hours}h"
        logger.info(
