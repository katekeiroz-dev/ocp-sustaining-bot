...
class SlackClient:
    ...
    def send_message(self, channel: str, text: str = None, blocks: list = None) -> bool:
        ...
        try:
            ...
            logger.error(f"Slack API error sending message to {channel}: {e.response['error']}")
            return False
    ...
    def send_dm(self, user_id: str, text: str = None, blocks: list = None) -> bool:
        ...
        try:
            ...
            logger.error(f"Slack API error sending DM to {user_id}: {e.response['error']}")
            return False
        except Exception as e:
    ...
    def get_user_info(self, user_id: str) -> dict:
        ...
        try:
            ...
            logger.error(f"Slack API error getting user info for {user_id}: {e.response['error']}")
            return {}
        except Exception as e:
